 ...
 * {@link MainArtistActivityFragment.Callbacks} interface
 * to listen for item selections.
 */
public class MainArtistActivity extends FragmentActivity
        implements MainArtistActivityFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.frame_top_tracks) != null) {
            ...
            ((MainArtistActivityFragment) getSupportFragmentManager()
    ...
    /**
     * Callback method from {@link MainArtistActivityFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(TopTracksActivityFragment.ARG_ITEM_ID, id);
            TopTracksActivityFragment fragment = new TopTracksActivityFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.frame_top_tracks, fragment)
                    .commit();
            ...
            detailIntent.putExtra(TopTracksActivityFragment.ARG_ITEM_ID, id);
